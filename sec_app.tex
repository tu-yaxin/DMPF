...
\begin{table*}
	...
	\label{tab:LPN_error_distribution}
		\begin{tabular}{cccc}
            ...
            \multirow{2}{*}{Big-state DMPF} & regular & $c^2t^2(\lambda+\frac{4}{3}t)\log (2N)+c^2t^2\log p$ & $8c^2N\times$PRG \\
            %\cline{2-4}
...
\Yaxin{One caveat: can bath-code / OKVS-based DMPF fit into the regular design, while it requires shares of $1,2,3$-point functions?}
