...
The above arguments, combined with \Cref{lem:paradigm_secure}, concludes that the big-state DMPF is computationally secure. 
...
The above arguments, combined with \Cref{lem:paradigm_secure}, concludes that the OKVS-based DMPF is computationally secure. 
