...
We take $w=3$, the most common option that outruns other choices of $w$ in terms of running time. Restating the conclusion in  \cite{cryptoeprint:2022/320}: given $n$ and $\lambda_\stat$, the choices of $e$ and $\hat{g}$ are $e = 1.223+\frac{\lambda_\stat+9.2}{4.144 n^{0.55}}$ and $\hat{g}=\frac{\lambda_\stat}{\log_2(en)}$. 
